...
{
    [WizNotificationCenter postMessageWithName:MessageTypeOfUploadDone userInfoObject:guid userInfoKey:UserInfoTypeOfUploadGUID];
}
+ (NSString*) getUploaddGUID:(NSNotification*)nc
{
    NSDictionary* userInfo = [nc userInfo];
    return [userInfo valueForKey:UserInfoTypeOfUploadGUID];
}
@end