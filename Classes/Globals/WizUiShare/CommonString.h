...
#define WizStrSyncingdeletednotes       NSLocalizedString(@"Syncing deleted notes", nil)
...
#define WizStrThesyncprocesswillstop    NSLocalizedString(@"The sync process will stop!", nil)
...
#define WizStrIfyouchoosetoeditthisdocument                 NSLocalizedString(@"If you choose to edit this document, images and text-formatting will be lost.", nil)
...
#define WizStrPleasewaitwhileloggingin                  NSLocalizedString(@"Please wait while logging in!", nil)
